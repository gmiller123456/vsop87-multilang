...
class vsop87e_nano_velocities {
   static getEarth(t){
      ...
      temp.push(vsop87e_nano_velocities.earth_x(t) / 365250.0);
      temp.push(vsop87e_nano_velocities.earth_y(t) / 365250.0);
      temp.push(vsop87e_nano_velocities.earth_z(t) / 365250.0);
      return temp;
   }

   static getJupiter(t){
      const temp=new Array();
      temp.push(vsop87e_nano_velocities.jupiter_x(t) / 365250.0);
      temp.push(vsop87e_nano_velocities.jupiter_y(t) / 365250.0);
      temp.push(vsop87e_nano_velocities.jupiter_z(t) / 365250.0);
      return temp;
   }

   static getMars(t){
      const temp=new Array();
      temp.push(vsop87e_nano_velocities.mars_x(t) / 365250.0);
      temp.push(vsop87e_nano_velocities.mars_y(t) / 365250.0);
      temp.push(vsop87e_nano_velocities.mars_z(t) / 365250.0);
      return temp;
   }

   static getMercury(t){
      const temp=new Array();
      temp.push(vsop87e_nano_velocities.mercury_x(t) / 365250.0);
      temp.push(vsop87e_nano_velocities.mercury_y(t) / 365250.0);
      temp.push(vsop87e_nano_velocities.mercury_z(t) / 365250.0);
      return temp;
   }

   static getNeptune(t){
      const temp=new Array();
      temp.push(vsop87e_nano_velocities.neptune_x(t) / 365250.0);
      temp.push(vsop87e_nano_velocities.neptune_y(t) / 365250.0);
      temp.push(vsop87e_nano_velocities.neptune_z(t) / 365250.0);
      return temp;
   }

   static getSaturn(t){
      const temp=new Array();
      temp.push(vsop87e_nano_velocities.saturn_x(t) / 365250.0);
      temp.push(vsop87e_nano_velocities.saturn_y(t) / 365250.0);
      temp.push(vsop87e_nano_velocities.saturn_z(t) / 365250.0);
      return temp;
   }

   static getUranus(t){
      const temp=new Array();
      temp.push(vsop87e_nano_velocities.uranus_x(t) / 365250.0);
      temp.push(vsop87e_nano_velocities.uranus_y(t) / 365250.0);
      temp.push(vsop87e_nano_velocities.uranus_z(t) / 365250.0);
      return temp;
   }

   static getVenus(t){
      const temp=new Array();
      temp.push(vsop87e_nano_velocities.venus_x(t) / 365250.0);
      temp.push(vsop87e_nano_velocities.venus_y(t) / 365250.0);
      temp.push(vsop87e_nano_velocities.venus_z(t) / 365250.0);
      return temp;
   }

   static getSun(t){
      const temp=new Array();
      temp.push(vsop87e_nano_velocities.sun_x(t) / 365250.0);
      temp.push(vsop87e_nano_velocities.sun_y(t) / 365250.0);
      temp.push(vsop87e_nano_velocities.sun_z(t) / 365250.0);
      return temp;
   }
