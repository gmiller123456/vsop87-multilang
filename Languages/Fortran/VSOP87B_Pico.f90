...
module VSOP87B_Pico
    ...
    contains
    subroutine VSOP87B_Pico_getEarth(t, result)
        double precision :: t
    ...
    subroutine VSOP87B_Pico_getJupiter(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87B_Pico_getMars(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87B_Pico_getMercury(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87B_Pico_getNeptune(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87B_Pico_getSaturn(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87B_Pico_getUranus(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87B_Pico_getVenus(t, result)
        double precision :: t
        double precision, dimension(3) :: result
