...
module VSOP87A_Milli_Velocities
    implicit none

    contains
    subroutine VSOP87A_Milli_getEarthV(t, result)
        double precision :: t
    ...
    subroutine VSOP87A_Milli_getEmbV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87A_Milli_getJupiterV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87A_Milli_getMarsV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87A_Milli_getMercuryV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87A_Milli_getNeptuneV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87A_Milli_getSaturnV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87A_Milli_getUranusV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87A_Milli_getVenusV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
...
end module VSOP87A_Milli_Velocities
