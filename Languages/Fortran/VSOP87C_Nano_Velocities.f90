...
module VSOP87C_Nano_Velocities
    implicit none

    contains
    subroutine VSOP87C_Nano_getEarthV(t, result)
        double precision :: t
    ...
    subroutine VSOP87C_Nano_getJupiterV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87C_Nano_getMarsV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87C_Nano_getMercuryV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87C_Nano_getNeptuneV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87C_Nano_getSaturnV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87C_Nano_getUranusV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87C_Nano_getVenusV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
...
end module VSOP87C_Nano_Velocities
