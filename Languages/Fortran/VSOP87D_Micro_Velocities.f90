...
module VSOP87D_Micro_Velocities
    implicit none

    contains
    subroutine VSOP87D_Micro_getEarthV(t, result)
        double precision :: t
    ...
    subroutine VSOP87D_Micro_getJupiterV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87D_Micro_getMarsV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87D_Micro_getMercuryV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87D_Micro_getNeptuneV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87D_Micro_getSaturnV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87D_Micro_getUranusV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87D_Micro_getVenusV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
...
end module VSOP87D_Micro_Velocities
