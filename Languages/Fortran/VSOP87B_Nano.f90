...
module VSOP87B_Nano
    ...
    contains
    subroutine VSOP87B_Nano_getEarth(t, result)
        double precision :: t
    ...
    subroutine VSOP87B_Nano_getJupiter(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87B_Nano_getMars(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87B_Nano_getMercury(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87B_Nano_getNeptune(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87B_Nano_getSaturn(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87B_Nano_getUranus(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87B_Nano_getVenus(t, result)
        double precision :: t
        double precision, dimension(3) :: result
