...
module VSOP87D_Pico_Velocities
    implicit none

    contains
    subroutine VSOP87D_Pico_getEarthV(t, result)
        double precision :: t
    ...
    subroutine VSOP87D_Pico_getJupiterV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87D_Pico_getMarsV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87D_Pico_getMercuryV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87D_Pico_getNeptuneV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87D_Pico_getSaturnV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87D_Pico_getUranusV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87D_Pico_getVenusV(t, result)
        double precision :: t
        double precision, dimension(3) :: result
...
end module VSOP87D_Pico_Velocities
