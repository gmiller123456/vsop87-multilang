...
module VSOP87D_Milli
    implicit none

    contains
    subroutine VSOP87D_Milli_getEarth(t, result)
        double precision :: t
    ...
    subroutine VSOP87D_Milli_getJupiter(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87D_Milli_getMars(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87D_Milli_getMercury(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87D_Milli_getNeptune(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87D_Milli_getSaturn(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87D_Milli_getUranus(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87D_Milli_getVenus(t, result)
        double precision :: t
        double precision, dimension(3) :: result
