...
module VSOP87C_Micro
    implicit none

    contains
    subroutine VSOP87C_Micro_getEarth(t, result)
        double precision :: t
    ...
    subroutine VSOP87C_Micro_getJupiter(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87C_Micro_getMars(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87C_Micro_getMercury(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87C_Micro_getNeptune(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87C_Micro_getSaturn(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87C_Micro_getUranus(t, result)
        double precision :: t
        double precision, dimension(3) :: result
    ...
    subroutine VSOP87C_Micro_getVenus(t, result)
        double precision :: t
        double precision, dimension(3) :: result
