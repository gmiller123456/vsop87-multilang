...
procedure vsop87a_pico_velocities_getEarth(t: Double;temp: array of Double);
procedure vsop87a_pico_velocities_getEmb(t: Double;temp: array of Double);
procedure vsop87a_pico_velocities_getJupiter(t: Double;temp: array of Double);
procedure vsop87a_pico_velocities_getMars(t: Double;temp: array of Double);
procedure vsop87a_pico_velocities_getMercury(t: Double;temp: array of Double);
procedure vsop87a_pico_velocities_getNeptune(t: Double;temp: array of Double);
procedure vsop87a_pico_velocities_getSaturn(t: Double;temp: array of Double);
procedure vsop87a_pico_velocities_getUranus(t: Double;temp: array of Double);
procedure vsop87a_pico_velocities_getVenus(t: Double;temp: array of Double);
procedure vsop87a_pico_velocities_getMoon(earth: array of Double; emb: array of Double;temp: array of Double);
