...
procedure vsop87d_micro_getEarth(t: Double;temp: array of Double);
procedure vsop87d_micro_getJupiter(t: Double;temp: array of Double);
procedure vsop87d_micro_getMars(t: Double;temp: array of Double);
procedure vsop87d_micro_getMercury(t: Double;temp: array of Double);
procedure vsop87d_micro_getNeptune(t: Double;temp: array of Double);
procedure vsop87d_micro_getSaturn(t: Double;temp: array of Double);
procedure vsop87d_micro_getUranus(t: Double;temp: array of Double);
procedure vsop87d_micro_getVenus(t: Double;temp: array of Double);
