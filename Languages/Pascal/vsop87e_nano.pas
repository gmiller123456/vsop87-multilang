...
procedure vsop87e_nano_getEarth(t: Double;temp: array of Double);
procedure vsop87e_nano_getJupiter(t: Double;temp: array of Double);
procedure vsop87e_nano_getMars(t: Double;temp: array of Double);
procedure vsop87e_nano_getMercury(t: Double;temp: array of Double);
procedure vsop87e_nano_getNeptune(t: Double;temp: array of Double);
procedure vsop87e_nano_getSaturn(t: Double;temp: array of Double);
procedure vsop87e_nano_getUranus(t: Double;temp: array of Double);
procedure vsop87e_nano_getVenus(t: Double;temp: array of Double);
procedure vsop87e_nano_getSun(t: Double;temp: array of Double);
