...
procedure vsop87c_nano_getEarth(t: Double;temp: array of Double);
procedure vsop87c_nano_getJupiter(t: Double;temp: array of Double);
procedure vsop87c_nano_getMars(t: Double;temp: array of Double);
procedure vsop87c_nano_getMercury(t: Double;temp: array of Double);
procedure vsop87c_nano_getNeptune(t: Double;temp: array of Double);
procedure vsop87c_nano_getSaturn(t: Double;temp: array of Double);
procedure vsop87c_nano_getUranus(t: Double;temp: array of Double);
procedure vsop87c_nano_getVenus(t: Double;temp: array of Double);
