...
procedure vsop87e_milli_getEarth(t: Double;temp: array of Double);
procedure vsop87e_milli_getJupiter(t: Double;temp: array of Double);
procedure vsop87e_milli_getMars(t: Double;temp: array of Double);
procedure vsop87e_milli_getMercury(t: Double;temp: array of Double);
procedure vsop87e_milli_getNeptune(t: Double;temp: array of Double);
procedure vsop87e_milli_getSaturn(t: Double;temp: array of Double);
procedure vsop87e_milli_getUranus(t: Double;temp: array of Double);
procedure vsop87e_milli_getVenus(t: Double;temp: array of Double);
procedure vsop87e_milli_getSun(t: Double;temp: array of Double);
