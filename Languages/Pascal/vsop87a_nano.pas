...
procedure vsop87a_nano_getEarth(double t,double temp[]);
procedure vsop87a_nano_getEmb(double t,double temp[]);
procedure vsop87a_nano_getJupiter(double t,double temp[]);
procedure vsop87a_nano_getMars(double t,double temp[]);
procedure vsop87a_nano_getMercury(double t,double temp[]);
procedure vsop87a_nano_getNeptune(double t,double temp[]);
procedure vsop87a_nano_getSaturn(double t,double temp[]);
procedure vsop87a_nano_getUranus(double t,double temp[]);
procedure vsop87a_nano_getVenus(double t,double temp[]);
procedure vsop87a_nano_getMoon(double earth[], double emb[],double temp[]);

implementation

procedure vsop87a_nano_getEarth(t: Double,temp: array of Double)
begin
...
procedure vsop87a_nano_getEmb(t: Double,temp: array of Double)
begin
...
procedure vsop87a_nano_getJupiter(t: Double,temp: array of Double)
begin
...
procedure vsop87a_nano_getMars(t: Double,temp: array of Double)
begin
...
procedure vsop87a_nano_getMercury(t: Double,temp: array of Double)
begin
...
procedure vsop87a_nano_getNeptune(t: Double,temp: array of Double)
begin
...
procedure vsop87a_nano_getSaturn(t: Double,temp: array of Double)
begin
...
procedure vsop87a_nano_getUranus(t: Double,temp: array of Double)
begin
...
procedure vsop87a_nano_getVenus(t: Double,temp: array of Double)
begin
...
procedure vsop87a_nano_getMoon(earth: array of Double, emb: array of Double,temp: array of Double)
begin
