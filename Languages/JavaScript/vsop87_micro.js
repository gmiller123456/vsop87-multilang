...
class vsop87_micro {
   static getEmb(t){
      ...
      temp.push(vsop87_micro.emb_a(t));
      temp.push(vsop87_micro.emb_l(t));
      temp.push(vsop87_micro.emb_k(t));
      temp.push(vsop87_micro.emb_h(t));
      temp.push(vsop87_micro.emb_q(t));
      temp.push(vsop87_micro.emb_p(t));
      return temp;
   }

   static getJupiter(t){
      const temp=new Array();
      temp.push(vsop87_micro.jupiter_a(t));
      temp.push(vsop87_micro.jupiter_l(t));
      temp.push(vsop87_micro.jupiter_k(t));
      temp.push(vsop87_micro.jupiter_h(t));
      temp.push(vsop87_micro.jupiter_q(t));
      temp.push(vsop87_micro.jupiter_p(t));
      return temp;
   }

   static getMars(t){
      const temp=new Array();
      temp.push(vsop87_micro.mars_a(t));
      temp.push(vsop87_micro.mars_l(t));
      temp.push(vsop87_micro.mars_k(t));
      temp.push(vsop87_micro.mars_h(t));
      temp.push(vsop87_micro.mars_q(t));
      temp.push(vsop87_micro.mars_p(t));
      return temp;
   }

   static getMercury(t){
      const temp=new Array();
      temp.push(vsop87_micro.mercury_a(t));
      temp.push(vsop87_micro.mercury_l(t));
      temp.push(vsop87_micro.mercury_k(t));
      temp.push(vsop87_micro.mercury_h(t));
      temp.push(vsop87_micro.mercury_q(t));
      temp.push(vsop87_micro.mercury_p(t));
      return temp;
   }

   static getNeptune(t){
      const temp=new Array();
      temp.push(vsop87_micro.neptune_a(t));
      temp.push(vsop87_micro.neptune_l(t));
      temp.push(vsop87_micro.neptune_k(t));
      temp.push(vsop87_micro.neptune_h(t));
      temp.push(vsop87_micro.neptune_q(t));
      temp.push(vsop87_micro.neptune_p(t));
      return temp;
   }

   static getSaturn(t){
      const temp=new Array();
      temp.push(vsop87_micro.saturn_a(t));
      temp.push(vsop87_micro.saturn_l(t));
      temp.push(vsop87_micro.saturn_k(t));
      temp.push(vsop87_micro.saturn_h(t));
      temp.push(vsop87_micro.saturn_q(t));
      temp.push(vsop87_micro.saturn_p(t));
      return temp;
   }

   static getUranus(t){
      const temp=new Array();
      temp.push(vsop87_micro.uranus_a(t));
      temp.push(vsop87_micro.uranus_l(t));
      temp.push(vsop87_micro.uranus_k(t));
      temp.push(vsop87_micro.uranus_h(t));
      temp.push(vsop87_micro.uranus_q(t));
      temp.push(vsop87_micro.uranus_p(t));
      return temp;
   }

   static getVenus(t){
      const temp=new Array();
      temp.push(vsop87_micro.venus_a(t));
      temp.push(vsop87_micro.venus_l(t));
      temp.push(vsop87_micro.venus_k(t));
      temp.push(vsop87_micro.venus_h(t));
      temp.push(vsop87_micro.venus_q(t));
      temp.push(vsop87_micro.venus_p(t));
      return temp;
   }
