...
class vsop87a_milli {
   static getEarth(t){
      ...
      temp.push(vsop87a_milli.earth_x(t));
      temp.push(vsop87a_milli.earth_y(t));
      temp.push(vsop87a_milli.earth_z(t));
      return temp;
   }

   static getEmb(t){
      const temp=new Array();
      temp.push(vsop87a_milli.emb_x(t));
      temp.push(vsop87a_milli.emb_y(t));
      temp.push(vsop87a_milli.emb_z(t));
      return temp;
   }

   static getJupiter(t){
      const temp=new Array();
      temp.push(vsop87a_milli.jupiter_x(t));
      temp.push(vsop87a_milli.jupiter_y(t));
      temp.push(vsop87a_milli.jupiter_z(t));
      return temp;
   }

   static getMars(t){
      const temp=new Array();
      temp.push(vsop87a_milli.mars_x(t));
      temp.push(vsop87a_milli.mars_y(t));
      temp.push(vsop87a_milli.mars_z(t));
      return temp;
   }

   static getMercury(t){
      const temp=new Array();
      temp.push(vsop87a_milli.mercury_x(t));
      temp.push(vsop87a_milli.mercury_y(t));
      temp.push(vsop87a_milli.mercury_z(t));
      return temp;
   }

   static getNeptune(t){
      const temp=new Array();
      temp.push(vsop87a_milli.neptune_x(t));
      temp.push(vsop87a_milli.neptune_y(t));
      temp.push(vsop87a_milli.neptune_z(t));
      return temp;
   }

   static getSaturn(t){
      const temp=new Array();
      temp.push(vsop87a_milli.saturn_x(t));
      temp.push(vsop87a_milli.saturn_y(t));
      temp.push(vsop87a_milli.saturn_z(t));
      return temp;
   }

   static getUranus(t){
      const temp=new Array();
      temp.push(vsop87a_milli.uranus_x(t));
      temp.push(vsop87a_milli.uranus_y(t));
      temp.push(vsop87a_milli.uranus_z(t));
      return temp;
   }

   static getVenus(t){
      const temp=new Array();
      temp.push(vsop87a_milli.venus_x(t));
      temp.push(vsop87a_milli.venus_y(t));
      temp.push(vsop87a_milli.venus_z(t));
      return temp;
   }
