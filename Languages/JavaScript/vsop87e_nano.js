...
class vsop87e_nano {
   static getEarth(t){
      ...
      temp.push(vsop87e_nano.earth_x(t));
      temp.push(vsop87e_nano.earth_y(t));
      temp.push(vsop87e_nano.earth_z(t));
      return temp;
   }

   static getJupiter(t){
      const temp=new Array();
      temp.push(vsop87e_nano.jupiter_x(t));
      temp.push(vsop87e_nano.jupiter_y(t));
      temp.push(vsop87e_nano.jupiter_z(t));
      return temp;
   }

   static getMars(t){
      const temp=new Array();
      temp.push(vsop87e_nano.mars_x(t));
      temp.push(vsop87e_nano.mars_y(t));
      temp.push(vsop87e_nano.mars_z(t));
      return temp;
   }

   static getMercury(t){
      const temp=new Array();
      temp.push(vsop87e_nano.mercury_x(t));
      temp.push(vsop87e_nano.mercury_y(t));
      temp.push(vsop87e_nano.mercury_z(t));
      return temp;
   }

   static getNeptune(t){
      const temp=new Array();
      temp.push(vsop87e_nano.neptune_x(t));
      temp.push(vsop87e_nano.neptune_y(t));
      temp.push(vsop87e_nano.neptune_z(t));
      return temp;
   }

   static getSaturn(t){
      const temp=new Array();
      temp.push(vsop87e_nano.saturn_x(t));
      temp.push(vsop87e_nano.saturn_y(t));
      temp.push(vsop87e_nano.saturn_z(t));
      return temp;
   }

   static getUranus(t){
      const temp=new Array();
      temp.push(vsop87e_nano.uranus_x(t));
      temp.push(vsop87e_nano.uranus_y(t));
      temp.push(vsop87e_nano.uranus_z(t));
      return temp;
   }

   static getVenus(t){
      const temp=new Array();
      temp.push(vsop87e_nano.venus_x(t));
      temp.push(vsop87e_nano.venus_y(t));
      temp.push(vsop87e_nano.venus_z(t));
      return temp;
   }

   static getSun(t){
      const temp=new Array();
      temp.push(vsop87e_nano.sun_x(t));
      temp.push(vsop87e_nano.sun_y(t));
      temp.push(vsop87e_nano.sun_z(t));
      return temp;
   }
