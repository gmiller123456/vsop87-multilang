...
class vsop87e_xsmall {
   static getEarth(t){
      ...
      temp.push(vsop87e_xsmall.earth_x(t));
      temp.push(vsop87e_xsmall.earth_y(t));
      temp.push(vsop87e_xsmall.earth_z(t));
      return temp;
   }

   static getJupiter(t){
      const temp=new Array();
      temp.push(vsop87e_xsmall.jupiter_x(t));
      temp.push(vsop87e_xsmall.jupiter_y(t));
      temp.push(vsop87e_xsmall.jupiter_z(t));
      return temp;
   }

   static getMars(t){
      const temp=new Array();
      temp.push(vsop87e_xsmall.mars_x(t));
      temp.push(vsop87e_xsmall.mars_y(t));
      temp.push(vsop87e_xsmall.mars_z(t));
      return temp;
   }

   static getMercury(t){
      const temp=new Array();
      temp.push(vsop87e_xsmall.mercury_x(t));
      temp.push(vsop87e_xsmall.mercury_y(t));
      temp.push(vsop87e_xsmall.mercury_z(t));
      return temp;
   }

   static getNeptune(t){
      const temp=new Array();
      temp.push(vsop87e_xsmall.neptune_x(t));
      temp.push(vsop87e_xsmall.neptune_y(t));
      temp.push(vsop87e_xsmall.neptune_z(t));
      return temp;
   }

   static getSaturn(t){
      const temp=new Array();
      temp.push(vsop87e_xsmall.saturn_x(t));
      temp.push(vsop87e_xsmall.saturn_y(t));
      temp.push(vsop87e_xsmall.saturn_z(t));
      return temp;
   }

   static getUranus(t){
      const temp=new Array();
      temp.push(vsop87e_xsmall.uranus_x(t));
      temp.push(vsop87e_xsmall.uranus_y(t));
      temp.push(vsop87e_xsmall.uranus_z(t));
      return temp;
   }

   static getVenus(t){
      const temp=new Array();
      temp.push(vsop87e_xsmall.venus_x(t));
      temp.push(vsop87e_xsmall.venus_y(t));
      temp.push(vsop87e_xsmall.venus_z(t));
      return temp;
   }

   static getSun(t){
      const temp=new Array();
      temp.push(vsop87e_xsmall.sun_x(t));
      temp.push(vsop87e_xsmall.sun_y(t));
      temp.push(vsop87e_xsmall.sun_z(t));
      return temp;
   }
