...
class vsop87b_micro {
   static getEarth(t){
      ...
      temp.push(vsop87b_micro.earth_l(t));
      temp.push(vsop87b_micro.earth_b(t));
      temp.push(vsop87b_micro.earth_r(t));
      return temp;
   }

   static getJupiter(t){
      const temp=new Array();
      temp.push(vsop87b_micro.jupiter_l(t));
      temp.push(vsop87b_micro.jupiter_b(t));
      temp.push(vsop87b_micro.jupiter_r(t));
      return temp;
   }

   static getMars(t){
      const temp=new Array();
      temp.push(vsop87b_micro.mars_l(t));
      temp.push(vsop87b_micro.mars_b(t));
      temp.push(vsop87b_micro.mars_r(t));
      return temp;
   }

   static getMercury(t){
      const temp=new Array();
      temp.push(vsop87b_micro.mercury_l(t));
      temp.push(vsop87b_micro.mercury_b(t));
      temp.push(vsop87b_micro.mercury_r(t));
      return temp;
   }

   static getNeptune(t){
      const temp=new Array();
      temp.push(vsop87b_micro.neptune_l(t));
      temp.push(vsop87b_micro.neptune_b(t));
      temp.push(vsop87b_micro.neptune_r(t));
      return temp;
   }

   static getSaturn(t){
      const temp=new Array();
      temp.push(vsop87b_micro.saturn_l(t));
      temp.push(vsop87b_micro.saturn_b(t));
      temp.push(vsop87b_micro.saturn_r(t));
      return temp;
   }

   static getUranus(t){
      const temp=new Array();
      temp.push(vsop87b_micro.uranus_l(t));
      temp.push(vsop87b_micro.uranus_b(t));
      temp.push(vsop87b_micro.uranus_r(t));
      return temp;
   }

   static getVenus(t){
      const temp=new Array();
      temp.push(vsop87b_micro.venus_l(t));
      temp.push(vsop87b_micro.venus_b(t));
      temp.push(vsop87b_micro.venus_r(t));
      return temp;
   }
