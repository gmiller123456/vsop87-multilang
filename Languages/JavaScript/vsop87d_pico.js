...
class vsop87d_pico {
   static getEarth(t){
      ...
      temp.push(vsop87d_pico.earth_l(t));
      temp.push(vsop87d_pico.earth_b(t));
      temp.push(vsop87d_pico.earth_r(t));
      return temp;
   }

   static getJupiter(t){
      const temp=new Array();
      temp.push(vsop87d_pico.jupiter_l(t));
      temp.push(vsop87d_pico.jupiter_b(t));
      temp.push(vsop87d_pico.jupiter_r(t));
      return temp;
   }

   static getMars(t){
      const temp=new Array();
      temp.push(vsop87d_pico.mars_l(t));
      temp.push(vsop87d_pico.mars_b(t));
      temp.push(vsop87d_pico.mars_r(t));
      return temp;
   }

   static getMercury(t){
      const temp=new Array();
      temp.push(vsop87d_pico.mercury_l(t));
      temp.push(vsop87d_pico.mercury_b(t));
      temp.push(vsop87d_pico.mercury_r(t));
      return temp;
   }

   static getNeptune(t){
      const temp=new Array();
      temp.push(vsop87d_pico.neptune_l(t));
      temp.push(vsop87d_pico.neptune_b(t));
      temp.push(vsop87d_pico.neptune_r(t));
      return temp;
   }

   static getSaturn(t){
      const temp=new Array();
      temp.push(vsop87d_pico.saturn_l(t));
      temp.push(vsop87d_pico.saturn_b(t));
      temp.push(vsop87d_pico.saturn_r(t));
      return temp;
   }

   static getUranus(t){
      const temp=new Array();
      temp.push(vsop87d_pico.uranus_l(t));
      temp.push(vsop87d_pico.uranus_b(t));
      temp.push(vsop87d_pico.uranus_r(t));
      return temp;
   }

   static getVenus(t){
      const temp=new Array();
      temp.push(vsop87d_pico.venus_l(t));
      temp.push(vsop87d_pico.venus_b(t));
      temp.push(vsop87d_pico.venus_r(t));
      return temp;
   }
