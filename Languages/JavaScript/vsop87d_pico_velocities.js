...
class vsop87d_pico_velocities {
   static getEarth(t){
      ...
      temp.push(vsop87d_pico_velocities.earth_l(t) / 365250.0);
      temp.push(vsop87d_pico_velocities.earth_b(t) / 365250.0);
      temp.push(vsop87d_pico_velocities.earth_r(t) / 365250.0);
      return temp;
   }

   static getJupiter(t){
      const temp=new Array();
      temp.push(vsop87d_pico_velocities.jupiter_l(t) / 365250.0);
      temp.push(vsop87d_pico_velocities.jupiter_b(t) / 365250.0);
      temp.push(vsop87d_pico_velocities.jupiter_r(t) / 365250.0);
      return temp;
   }

   static getMars(t){
      const temp=new Array();
      temp.push(vsop87d_pico_velocities.mars_l(t) / 365250.0);
      temp.push(vsop87d_pico_velocities.mars_b(t) / 365250.0);
      temp.push(vsop87d_pico_velocities.mars_r(t) / 365250.0);
      return temp;
   }

   static getMercury(t){
      const temp=new Array();
      temp.push(vsop87d_pico_velocities.mercury_l(t) / 365250.0);
      temp.push(vsop87d_pico_velocities.mercury_b(t) / 365250.0);
      temp.push(vsop87d_pico_velocities.mercury_r(t) / 365250.0);
      return temp;
   }

   static getNeptune(t){
      const temp=new Array();
      temp.push(vsop87d_pico_velocities.neptune_l(t) / 365250.0);
      temp.push(vsop87d_pico_velocities.neptune_b(t) / 365250.0);
      temp.push(vsop87d_pico_velocities.neptune_r(t) / 365250.0);
      return temp;
   }

   static getSaturn(t){
      const temp=new Array();
      temp.push(vsop87d_pico_velocities.saturn_l(t) / 365250.0);
      temp.push(vsop87d_pico_velocities.saturn_b(t) / 365250.0);
      temp.push(vsop87d_pico_velocities.saturn_r(t) / 365250.0);
      return temp;
   }

   static getUranus(t){
      const temp=new Array();
      temp.push(vsop87d_pico_velocities.uranus_l(t) / 365250.0);
      temp.push(vsop87d_pico_velocities.uranus_b(t) / 365250.0);
      temp.push(vsop87d_pico_velocities.uranus_r(t) / 365250.0);
      return temp;
   }

   static getVenus(t){
      const temp=new Array();
      temp.push(vsop87d_pico_velocities.venus_l(t) / 365250.0);
      temp.push(vsop87d_pico_velocities.venus_b(t) / 365250.0);
      temp.push(vsop87d_pico_velocities.venus_r(t) / 365250.0);
      return temp;
   }
