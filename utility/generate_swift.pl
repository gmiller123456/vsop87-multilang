...
sub produceFile {
    ...
    open($f,">$filename.swift");
    open($h,">$filename"."_velocities.swift");
...
sub generateCoordFunctions{
    ...
    while($l=<$in>){
        ...
        if($var ne $lastVar){
            print $f "   static func $planet"."_$var(t:Double)->Double{\r\n";
            print $h "   static func $planet"."_$var(t:Double)->Double{\r\n";
        }
        ...
        if($vars[4]>= $precision){
            if($exponentHasData==0){
                ...
                print $f "      var $currentVar: Double = 0.0\r\n\r\n";
                print $h "      var $currentVar: Double = 0.0\r\n\r\n";
            }
...
sub generateGetMoon{
    my $t="";
        $t.= "   public static func getMoon(earth: Array<Double>, emb: Array<Double>) -> Array<Double> {\r\n";
...
sub generateGetPlanets{
    foreach my $p (@planets){
        ...
        my $t1="";
        my $t2="";
        $t.= "   public static func get$p(t: Double) -> Array<Double> {\r\n";
        ...
        for(my $i=0; $i<scalar @varNames; $i++){
            $t1.= "      temp[$i]=$lp"."_$varNames[$i](t:t)\r\n";
            $t2.= "      temp[$i]=$lp"."_$varNames[$i](t:t) / 365250.0\r\n";
        }
