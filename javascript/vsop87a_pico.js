...
class vsop87a_pico {
   static getEarth(t){
      ...
      temp.push(vsop87a_pico.earth_x(t));
      temp.push(vsop87a_pico.earth_y(t));
      temp.push(vsop87a_pico.earth_z(t));
      return temp;
   }

   static getEmb(t){
      const temp=new Array();
      temp.push(vsop87a_pico.emb_x(t));
      temp.push(vsop87a_pico.emb_y(t));
      temp.push(vsop87a_pico.emb_z(t));
      return temp;
   }

   static getJupiter(t){
      const temp=new Array();
      temp.push(vsop87a_pico.jupiter_x(t));
      temp.push(vsop87a_pico.jupiter_y(t));
      temp.push(vsop87a_pico.jupiter_z(t));
      return temp;
   }

   static getMars(t){
      const temp=new Array();
      temp.push(vsop87a_pico.mars_x(t));
      temp.push(vsop87a_pico.mars_y(t));
      temp.push(vsop87a_pico.mars_z(t));
      return temp;
   }

   static getMercury(t){
      const temp=new Array();
      temp.push(vsop87a_pico.mercury_x(t));
      temp.push(vsop87a_pico.mercury_y(t));
      temp.push(vsop87a_pico.mercury_z(t));
      return temp;
   }

   static getNeptune(t){
      const temp=new Array();
      temp.push(vsop87a_pico.neptune_x(t));
      temp.push(vsop87a_pico.neptune_y(t));
      temp.push(vsop87a_pico.neptune_z(t));
      return temp;
   }

   static getSaturn(t){
      const temp=new Array();
      temp.push(vsop87a_pico.saturn_x(t));
      temp.push(vsop87a_pico.saturn_y(t));
      temp.push(vsop87a_pico.saturn_z(t));
      return temp;
   }

   static getUranus(t){
      const temp=new Array();
      temp.push(vsop87a_pico.uranus_x(t));
      temp.push(vsop87a_pico.uranus_y(t));
      temp.push(vsop87a_pico.uranus_z(t));
      return temp;
   }

   static getVenus(t){
      const temp=new Array();
      temp.push(vsop87a_pico.venus_x(t));
      temp.push(vsop87a_pico.venus_y(t));
      temp.push(vsop87a_pico.venus_z(t));
      return temp;
   }
   ...
   static getMoon(earth, emb){
      ...
      temp.push(vsop87a_pico.temp[0]+earth[0]);
      temp.push(vsop87a_pico.temp[1]+earth[1]);
      temp.push(vsop87a_pico.temp[2]+earth[2]);
      return temp;
   }
