...
class vsop87c_pico {
   static getEarth(t){
      ...
      temp.push(vsop87c_pico.earth_x(t));
      temp.push(vsop87c_pico.earth_y(t));
      temp.push(vsop87c_pico.earth_z(t));
      return temp;
   }

   static getJupiter(t){
      const temp=new Array();
      temp.push(vsop87c_pico.jupiter_x(t));
      temp.push(vsop87c_pico.jupiter_y(t));
      temp.push(vsop87c_pico.jupiter_z(t));
      return temp;
   }

   static getMars(t){
      const temp=new Array();
      temp.push(vsop87c_pico.mars_x(t));
      temp.push(vsop87c_pico.mars_y(t));
      temp.push(vsop87c_pico.mars_z(t));
      return temp;
   }

   static getMercury(t){
      const temp=new Array();
      temp.push(vsop87c_pico.mercury_x(t));
      temp.push(vsop87c_pico.mercury_y(t));
      temp.push(vsop87c_pico.mercury_z(t));
      return temp;
   }

   static getNeptune(t){
      const temp=new Array();
      temp.push(vsop87c_pico.neptune_x(t));
      temp.push(vsop87c_pico.neptune_y(t));
      temp.push(vsop87c_pico.neptune_z(t));
      return temp;
   }

   static getSaturn(t){
      const temp=new Array();
      temp.push(vsop87c_pico.saturn_x(t));
      temp.push(vsop87c_pico.saturn_y(t));
      temp.push(vsop87c_pico.saturn_z(t));
      return temp;
   }

   static getUranus(t){
      const temp=new Array();
      temp.push(vsop87c_pico.uranus_x(t));
      temp.push(vsop87c_pico.uranus_y(t));
      temp.push(vsop87c_pico.uranus_z(t));
      return temp;
   }

   static getVenus(t){
      const temp=new Array();
      temp.push(vsop87c_pico.venus_x(t));
      temp.push(vsop87c_pico.venus_y(t));
      temp.push(vsop87c_pico.venus_z(t));
      return temp;
   }
