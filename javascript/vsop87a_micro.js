...
class vsop87a_micro {
   static getEarth(t){
      ...
      temp.push(vsop87a_micro.earth_x(t));
      temp.push(vsop87a_micro.earth_y(t));
      temp.push(vsop87a_micro.earth_z(t));
      return temp;
   }

   static getEmb(t){
      const temp=new Array();
      temp.push(vsop87a_micro.emb_x(t));
      temp.push(vsop87a_micro.emb_y(t));
      temp.push(vsop87a_micro.emb_z(t));
      return temp;
   }

   static getJupiter(t){
      const temp=new Array();
      temp.push(vsop87a_micro.jupiter_x(t));
      temp.push(vsop87a_micro.jupiter_y(t));
      temp.push(vsop87a_micro.jupiter_z(t));
      return temp;
   }

   static getMars(t){
      const temp=new Array();
      temp.push(vsop87a_micro.mars_x(t));
      temp.push(vsop87a_micro.mars_y(t));
      temp.push(vsop87a_micro.mars_z(t));
      return temp;
   }

   static getMercury(t){
      const temp=new Array();
      temp.push(vsop87a_micro.mercury_x(t));
      temp.push(vsop87a_micro.mercury_y(t));
      temp.push(vsop87a_micro.mercury_z(t));
      return temp;
   }

   static getNeptune(t){
      const temp=new Array();
      temp.push(vsop87a_micro.neptune_x(t));
      temp.push(vsop87a_micro.neptune_y(t));
      temp.push(vsop87a_micro.neptune_z(t));
      return temp;
   }

   static getSaturn(t){
      const temp=new Array();
      temp.push(vsop87a_micro.saturn_x(t));
      temp.push(vsop87a_micro.saturn_y(t));
      temp.push(vsop87a_micro.saturn_z(t));
      return temp;
   }

   static getUranus(t){
      const temp=new Array();
      temp.push(vsop87a_micro.uranus_x(t));
      temp.push(vsop87a_micro.uranus_y(t));
      temp.push(vsop87a_micro.uranus_z(t));
      return temp;
   }

   static getVenus(t){
      const temp=new Array();
      temp.push(vsop87a_micro.venus_x(t));
      temp.push(vsop87a_micro.venus_y(t));
      temp.push(vsop87a_micro.venus_z(t));
      return temp;
   }
   ...
   static getMoon(earth, emb){
      ...
      temp.push(vsop87a_micro.temp[0]+earth[0]);
      temp.push(vsop87a_micro.temp[1]+earth[1]);
      temp.push(vsop87a_micro.temp[2]+earth[2]);
      return temp;
   }
