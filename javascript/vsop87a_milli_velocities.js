...
class vsop87a_milli_velocities {
   static getEarth(t){
      ...
      temp.push(vsop87a_milli_velocities.earth_x(t) / 365250.0);
      temp.push(vsop87a_milli_velocities.earth_y(t) / 365250.0);
      temp.push(vsop87a_milli_velocities.earth_z(t) / 365250.0);
      return temp;
   }

   static getEmb(t){
      const temp=new Array();
      temp.push(vsop87a_milli_velocities.emb_x(t) / 365250.0);
      temp.push(vsop87a_milli_velocities.emb_y(t) / 365250.0);
      temp.push(vsop87a_milli_velocities.emb_z(t) / 365250.0);
      return temp;
   }

   static getJupiter(t){
      const temp=new Array();
      temp.push(vsop87a_milli_velocities.jupiter_x(t) / 365250.0);
      temp.push(vsop87a_milli_velocities.jupiter_y(t) / 365250.0);
      temp.push(vsop87a_milli_velocities.jupiter_z(t) / 365250.0);
      return temp;
   }

   static getMars(t){
      const temp=new Array();
      temp.push(vsop87a_milli_velocities.mars_x(t) / 365250.0);
      temp.push(vsop87a_milli_velocities.mars_y(t) / 365250.0);
      temp.push(vsop87a_milli_velocities.mars_z(t) / 365250.0);
      return temp;
   }

   static getMercury(t){
      const temp=new Array();
      temp.push(vsop87a_milli_velocities.mercury_x(t) / 365250.0);
      temp.push(vsop87a_milli_velocities.mercury_y(t) / 365250.0);
      temp.push(vsop87a_milli_velocities.mercury_z(t) / 365250.0);
      return temp;
   }

   static getNeptune(t){
      const temp=new Array();
      temp.push(vsop87a_milli_velocities.neptune_x(t) / 365250.0);
      temp.push(vsop87a_milli_velocities.neptune_y(t) / 365250.0);
      temp.push(vsop87a_milli_velocities.neptune_z(t) / 365250.0);
      return temp;
   }

   static getSaturn(t){
      const temp=new Array();
      temp.push(vsop87a_milli_velocities.saturn_x(t) / 365250.0);
      temp.push(vsop87a_milli_velocities.saturn_y(t) / 365250.0);
      temp.push(vsop87a_milli_velocities.saturn_z(t) / 365250.0);
      return temp;
   }

   static getUranus(t){
      const temp=new Array();
      temp.push(vsop87a_milli_velocities.uranus_x(t) / 365250.0);
      temp.push(vsop87a_milli_velocities.uranus_y(t) / 365250.0);
      temp.push(vsop87a_milli_velocities.uranus_z(t) / 365250.0);
      return temp;
   }

   static getVenus(t){
      const temp=new Array();
      temp.push(vsop87a_milli_velocities.venus_x(t) / 365250.0);
      temp.push(vsop87a_milli_velocities.venus_y(t) / 365250.0);
      temp.push(vsop87a_milli_velocities.venus_z(t) / 365250.0);
      return temp;
   }
   ...
   static getMoon(earth, emb){
      ...
      temp.push(vsop87a_milli_velocities.temp[0]+earth[0]);
      temp.push(vsop87a_milli_velocities.temp[1]+earth[1]);
      temp.push(vsop87a_milli_velocities.temp[2]+earth[2]);
      return temp;
   }
