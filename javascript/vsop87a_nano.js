...
class vsop87a_nano {
   static getEarth(t){
      ...
      temp.push(vsop87a_nano.earth_x(t));
      temp.push(vsop87a_nano.earth_y(t));
      temp.push(vsop87a_nano.earth_z(t));
      return temp;
   }

   static getEmb(t){
      const temp=new Array();
      temp.push(vsop87a_nano.emb_x(t));
      temp.push(vsop87a_nano.emb_y(t));
      temp.push(vsop87a_nano.emb_z(t));
      return temp;
   }

   static getJupiter(t){
      const temp=new Array();
      temp.push(vsop87a_nano.jupiter_x(t));
      temp.push(vsop87a_nano.jupiter_y(t));
      temp.push(vsop87a_nano.jupiter_z(t));
      return temp;
   }

   static getMars(t){
      const temp=new Array();
      temp.push(vsop87a_nano.mars_x(t));
      temp.push(vsop87a_nano.mars_y(t));
      temp.push(vsop87a_nano.mars_z(t));
      return temp;
   }

   static getMercury(t){
      const temp=new Array();
      temp.push(vsop87a_nano.mercury_x(t));
      temp.push(vsop87a_nano.mercury_y(t));
      temp.push(vsop87a_nano.mercury_z(t));
      return temp;
   }

   static getNeptune(t){
      const temp=new Array();
      temp.push(vsop87a_nano.neptune_x(t));
      temp.push(vsop87a_nano.neptune_y(t));
      temp.push(vsop87a_nano.neptune_z(t));
      return temp;
   }

   static getSaturn(t){
      const temp=new Array();
      temp.push(vsop87a_nano.saturn_x(t));
      temp.push(vsop87a_nano.saturn_y(t));
      temp.push(vsop87a_nano.saturn_z(t));
      return temp;
   }

   static getUranus(t){
      const temp=new Array();
      temp.push(vsop87a_nano.uranus_x(t));
      temp.push(vsop87a_nano.uranus_y(t));
      temp.push(vsop87a_nano.uranus_z(t));
      return temp;
   }

   static getVenus(t){
      const temp=new Array();
      temp.push(vsop87a_nano.venus_x(t));
      temp.push(vsop87a_nano.venus_y(t));
      temp.push(vsop87a_nano.venus_z(t));
      return temp;
   }
   ...
   static getMoon(earth, emb){
      ...
      temp.push(vsop87a_nano.temp[0]+earth[0]);
      temp.push(vsop87a_nano.temp[1]+earth[1]);
      temp.push(vsop87a_nano.temp[2]+earth[2]);
      return temp;
   }
